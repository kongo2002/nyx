...
- 64-bit static binary (built using musl libc): [nyx-1.9.8.tar.gz](http://uhlenheuer.net/files/nyx/static/nyx-1.9.8.tar.gz)
  (SHA1: `0eca5cea573a10713bcf6f2e03ce77c4e9333525`)
