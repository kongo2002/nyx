...
- 64-bit static binary (built using musl libc): [nyx-1.9.2.tar.gz](http://uhlenheuer.net/files/nyx/static/nyx-1.9.2.tar.gz)
  (SHA1: `a5b512265c18e484dd162eb18654b76bf33dea79`)
